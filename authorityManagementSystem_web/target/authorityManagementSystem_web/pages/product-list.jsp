							...
							<div class="pull-left">
								<div class="form-group form-inline">
									<div class="btn-group">
										...
										<a  type="button" class="btn btn-default" title="删除" name="delByCheck" onclick="delByCheck()">
										<i class="fa fa-trash-o"></i> 多选删除
									</a>
								...
								<div class="has-feedback">
									<form id="form1" action="${pageContext.request.contextPath}/product/findAll.do" method="post">
										<input type="text" class="form-control input-sm" name="fuzzyName" value="${fuzzyName}"
											   placeholder="产品名称搜索">
										<button type="submit"  class="bg-maroon glyphicon glyphicon-search form-control-feedback"></button>
									</form>
								</div>
							</div>
							<!--工具栏/-->
					...
					<div class="box-footer">
						<div class="pull-left">
							<div class="form-group form-inline">
								...
								每页 <select class="form-control" id="selectByPage" onchange="selectByPage()" >
									<option>1</option>
									<option>2</option>
									<option>3</option>
									<option>4</option>
						...
						<div class="box-tools pull-right">
							<ul class="pagination">
										<%--  pageSize页面数据数量 pageNum当前页码 pages总页数（尾页） total总页面数据数量							--%>
								<li><a href="${pageContext.request.contextPath}/product/findAll.do?page=1&size=${pageInfo.pageSize}&fuzzyName=${fuzzyName}"  aria-label="Previous">首页</a></li>
								<li><a href="${pageContext.request.contextPath}/product/findAll.do?page=${pageInfo.pageNum-1}&size=${pageInfo.pageSize}&fuzzyName=${fuzzyName}">上一页</a></li>
								<c:forEach begin="1" end="${pageInfo.pages}" var="pageNum">
									<li><a href="${pageContext.request.contextPath}/product/findAll.do?page=${pageNum}&size=${pageInfo.pageSize}&fuzzyName=${fuzzyName}">${pageNum}</a></li>
								</c:forEach>
								<li><a href="${pageContext.request.contextPath}/product/findAll.do?page=${pageInfo.pageNum+1}&size=${pageInfo.pageSize}&fuzzyName=${fuzzyName}">下一页</a></li>
								<li><a href="${pageContext.request.contextPath}/product/findAll.do?page=${pageInfo.pages}&size=${pageInfo.pageSize}&fuzzyName=${fuzzyName}" aria-label="Next">尾页</a></li>
							</ul>
						</div>
