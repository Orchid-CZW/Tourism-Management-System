									...
									<c:forEach items="${permissionList}" var="p">
										<tr>
											...
											<td class="text-center">
												...
												<a href="${pageContext.request.contextPath}/permission/deletePermissionById.do?permissionId=${p.id}" class="btn bg-olive btn-xs">删除资源权限</a>
											</td>
										</tr>
									</c:forEach>
								</tbody>
