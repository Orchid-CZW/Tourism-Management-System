...
public interface IOrdersDao {
    ...
    @Results({
            ...
            @Result(property = "product",column = "productId",javaType = Product.class,one = @One(select = "com.orchid.ssm.dao.IProductDao.findById")),
    })
    ...
    @Results({
            ...
            @Result(column = "productId",property = "product",javaType = Product.class ,one = @One(select = "com.orchid.ssm.dao.IProductDao.findById")),
            @Result(column = "memberId",property = "member",one = @One(select = "com.orchid.ssm.dao.IMemberDao.findById")),
            @Result(column = "id",property = "travellers",many = @Many(select = "com.orchid.ssm.dao.ITravellerDao.findByOrdersId")),
